<script lang="ts">
 ...
 <footer 
   class="bg-gray-900 text-gray-300 py-6 overflow-hidden"
   in:slide={{duration: 400, easing: quintOut}}
 >
   <div class="container mx-auto px-4 lg:px-6">
     <div class="flex flex-col items-center space-y-4">
       <h2 class="text-base font-light tracking-widest uppercase text-white">
         Nikita Shilov
       </h2>
       ...
       <p class="text-xs text-gray-400">
         © {currentYear} Nikita Shilov. All rights reserved.
       </p>
     </div>
   </div>
 </footer>